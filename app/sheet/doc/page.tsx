...
// This is the raw paper document, rendered inside the MakoOS spec-sheet
// viewer window via iframe. Direct visits are fine, but /sheet (the OS
// framing) is the canonical address — keep this one out of the index.
export const metadata: Metadata = {
  title: "The Spec Sheet — MakoBytes on Paper",
  description:
    "The MakoBytes catalog as a machinist's spec sheet — PixelCopy and MakoBot, dimensioned, stamped, and signed. The paper version of MakoOS.",
    ...
    <main className="paper-grid relative min-h-screen text-[#26303b]">
      ...
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-[#d7dee6]/70 bg-white/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <a href="/" target="_top" className="flex items-center gap-3 whitespace-nowrap">
            <BrandMark size={36} />
          ...
          <div className="hidden items-center gap-8 text-sm text-[#55606c] md:flex">
            <a href="/" target="_top" className="font-semibold text-[#0061aa] transition hover:text-[#004d88]">
              ← MakoOS
            </a>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="mt-8 flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-[#55606c]">
              ...
              <a href="/privacy" target="_top" className="transition hover:text-[#0061aa]">
                Privacy
              </a>
              <a href="/terms" target="_top" className="transition hover:text-[#0061aa]">
                Terms
              </a>
              <a href="mailto:admin@makobytes.com" className="transition hover:text-[#0061aa]">
                Contact
